  ...
  return (
    <main className="flex flex-1 items-center justify-center bg-slate-50 px-6 py-16">
      <section className="w-full max-w-md rounded-3xl bg-white p-8 shadow-sm ring-1 ring-slate-200">
        <Link className="text-sm font-semibold text-emerald-700" href="/">← Allahın Şişkosu</Link>
        <h1 className="mt-6 text-3xl font-bold tracking-tight text-slate-950">Welcome</h1>
