  ...
  return (
    <div className="mt-8 grid gap-6 xl:grid-cols-[1.4fr_1fr]">
      <section className="space-y-3">
        {days.map((day, index) => {
          const plan = plans.find((item) => item.dayOfWeek === index);
          return (
            <Card className="p-0" key={day}>
      ...
      <aside>
        {editingDay === undefined ? (
          <EmptyState
            ...
            description="Choose a day to add a workout or mark it as rest."
          />
        ) : (
          <Card>
            <div className="flex items-start justify-between gap-3">
              <div>
                ...
                <h2 className="mt-1 text-xl font-bold">Workout plan</h2>
              </div>
              <button
