...
* add "What should I eat now" button to the coach page that will check what user ate today and what they need in terms of nutritions and recommend something to eat.
* add connections to settings for apple health, google health, fitbit, etc
* update profile for logged weight
* under progress page, convert weight trend chart to line chart with the goal weight displayed as a dashed line
