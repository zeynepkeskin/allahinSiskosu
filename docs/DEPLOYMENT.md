...
5. Before using nutrition features, apply `supabase/migrations/20260731000000_create_nutrition_schema.sql` in the Supabase SQL Editor (or with the Supabase CLI). This creates the application tables, signup profile trigger, and row-level security policies.
